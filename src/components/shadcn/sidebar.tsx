...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <button
      ...
      variant="ghost"
      className={cn(
        "p-1 relative hover:bg-zinc-100 rounded-full cursor-pointer dark:hover:bg-zinc-900"
      )}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
    ...
    >
      ...
      <PanelLeft
        ...
        style={{ width: "22px", height: "22px" }} // Increase SVG size
      />
...
>(({ className, ...props }, ref) => {
  ...
  // Add an onClick handler to close the sidebar on mobile
